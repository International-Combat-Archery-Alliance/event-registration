...
func TestPostEventsEventIdRegister(t *testing.T) {
	t.Run("invalid captcha", func(t *testing.T) {
		...
		api := NewAPI(&mockDB{}, noopLogger, LOCAL, newTestTokenValidator(), mockCaptcha, &mockEmailSender{}, &mockSubscriberManager{}, &mockCheckoutManagerReg{}, func(context.Context) error { return nil })
		reg := Registration{}
	...
	t.Run("invalid body", func(t *testing.T) {
		api := NewAPI(&mockDB{}, noopLogger, LOCAL, newTestTokenValidator(), &mockCaptchaValidator{}, &mockEmailSender{}, &mockSubscriberManager{}, &mockCheckoutManagerReg{}, func(context.Context) error { return nil })
		reg := Registration{}
	...
	t.Run("individual registration with player email", func(t *testing.T) {
		...
		api := NewAPI(mock, noopLogger, LOCAL, newTestTokenValidator(), mockCaptcha, &mockEmailSender{}, &mockSubscriberManager{}, &mockCheckoutManagerReg{}, func(context.Context) error { return nil })
