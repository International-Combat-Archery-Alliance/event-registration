...
func TestPostEventsV1AdminTestEmail_Success(t *testing.T) {
	api := NewAPI(&mockDB{}, noopLogger, LOCAL, newTestTokenValidator(), &mockCaptchaValidator{}, &mockEmailSender{}, &mockSubscriberManager{}, &mockCheckoutManager{}, func(context.Context) error { return nil })
...
func TestPostEventsV1AdminTestEmail_SendFailure(t *testing.T) {
	api := NewAPI(&mockDB{}, noopLogger, LOCAL, newTestTokenValidator(), &mockCaptchaValidator{}, &mockFailingEmailSender{}, &mockSubscriberManager{}, &mockCheckoutManager{}, func(context.Context) error { return nil })
